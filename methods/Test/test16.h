#ifndef GST_METHODS_TEST_TEST16_H
#define GST_METHODS_TEST_TEST16_H
...
namespace gst::methods::test16
{
struct Test16Stats
{
    int n = 0, m = 0, g = 0;
    int total_group_vertices = 0, max_group_size = 0, max_active = 0;
    long long total_valid = 0, total_inqueue = 0;
    long long pull_pairs = 0, pull_scan = 0, pull_hits = 0;
    long long h_pairs = 0, h_scan = 0, h_hits = 0, h_calls = 0;
    ...
    long long certify_try = 0, certify_success = 0, certify_by_lb = 0, certify_by_pop = 0;
