# GST Dual-Cut Potential：共享容量下界与零残量上界
...
当前 global-label 路线已经绕开整层 triple-row 物化并完成目标；新的生产化问题转为 small 工作量 gate、frontier 空间和单路径实现，见 `test19_research_directions.md`。
