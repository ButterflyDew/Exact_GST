# Pair-Row Predecessor Certificate（历史探针）
...
- Test36 曾让一个 source profile 同时传播全部 pair bits，试图直接减少 D2 图搜索；accepted events 虽下降，但异构 pair offsets 导致 fast 慢 `3.8x--45x`。该入口已撤出，见 `../archive/test36_pair_vector_wave_20260712.md`。
