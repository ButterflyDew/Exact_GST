...
> 冻结口径：正文中的“当前”仅指 Test18 冻结时状态，不覆盖 ReleaseV3。
...
```text
readme_files/history/test18_algorithm.md          Test18 合规快照和安全边界
readme_files/history/test18_effect_report.md      Test18 可引用效果和 O2 后计时
readme_files/archive/test18_failed_attempts_20260710.md  撤回/失败路线归档
readme_files/history/test19_algorithm.md          后续实验入口，Test18 的独立副本
readme_files/history/test19_maintenance.md        Test19 代码维护和拆分计划
```
