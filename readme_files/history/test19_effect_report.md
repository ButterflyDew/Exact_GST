...
`future_lb_probe` 对 admissibility、edge consistency 和跨 subset splice 条件均未发现 TSP/2 违规；公式和证明见 `test19_algorithm.md`，探针统计见 `../research_status.md`。
